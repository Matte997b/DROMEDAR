...
def main():
    ...
    if cond == 'SPI': 
        ...
        for dom in domain:
            file = f'/work_big/users/dromedar/bordoni/home/datasets/tp_ERA5/tp_tseries/ERA5_total_precipitation_day_2.0x2.0_sfc_1940-2023_{dom}.nc'
            folder_path_SPI_tmp = '/work_big/users/dromedar/bordoni/home/datasets/tp_ERA5/tmp_SPI_2_0'
        ...
        for dom in domain:
            file = f'/work_big/users/dromedar/bordoni/home/datasets/tp_minus_PET_ERA5/tp_m_PET_tseries/ERA5_P-PET_day_2.0x2.0_sfc_1940-2023_{dom}.nc'
            folder_path_SPEI_tmp = '/work_big/users/dromedar/bordoni/home/datasets/tp_minus_PET_ERA5/tmp_SPEI_2_0'
        ...
        for dom in domain:
            file_tp = f'/work_big/users/dromedar/bordoni/home/datasets/tp_ERA5/tp_tseries/ERA5_total_precipitation_day_2.0x2.0_sfc_1940-2023_{dom}.nc'
            file_PET = f'/work_big/users/dromedar/bordoni/home/datasets/PET_ERA5/PET_tseries/ERA5_PET_day_2.0x2.0_sfc_1940-2023_{dom}.nc'
            folder_path_RDI_tmp = '/work_big/users/dromedar/bordoni/home/datasets/tp_div_PET_ERA5/tmp_RDI_2_0'
